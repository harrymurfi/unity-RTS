...
public class Barracks : Building, ITrainable
{
	ResourceManager resoManager;
	public GameObject legionnairePrefab;
	public TrainTimeBar trainBar;
	...
	void TrainUnit()
	{
		...
		else
		{
			...
			else
			{
				...
				trainingPercent = 0;
				inTraining = false;
				Instantiate(legionnairePrefab, spawnPoint.position, Quaternion.identity);
			}
